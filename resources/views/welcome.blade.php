...
<body>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        <li class="nav-item active">
                            <a class="nav-link" href="#">{{ config('app.name') }} <span
                        ...
                        <li class="nav-item">
                            <router-link class="nav-link" to="/etudiant">Etudiant</router-link>
                        </li>
    ...
    <script src="{{ asset('vue/etudiant/etudiant.list.js') }}"></script>
    <script src="{{ asset('vue/etudiant/etudiant.item.js') }}"></script>
    <script src="{{ asset('vue/home.js') }}"></script>
